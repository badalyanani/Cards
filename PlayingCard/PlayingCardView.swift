...
class PlayingCardView: UIView {
    ...
    private lazy var upperLeftCornerLabel = createCornerLaber()
    private lazy var lowerRightCornerLabel = createCornerLaber()
    
    private func createCornerLaber() -> UILabel{
        let label = UILabel()
